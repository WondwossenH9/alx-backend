...
class LFUCache(BaseCaching):
    """Represents an obj that allows to store and
    retrieve items from a dict with a LFU
    removal mechanism till limit is reached
    """
    def __init__(self):
        """Initializes cache
        """
    ...
    def __reorder_items(self, mru_key):
        """Reorders items from cache based on most
        recently used item
        """
        max_positions = []
        mru_freq = 0
